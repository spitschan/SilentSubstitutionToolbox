...
% [T_quantalAbsorptionsNormalizedRod,T_quantalAbsorptionsRod,T_quantalIsomerizationsRod,adjIndDiffParams,params,staticParams] = ComputeCIERodFundamental(S,fieldSizeDegrees,ageInYears,pupilDiameterMm,indDiffParams)
%
% This function computes the rod fundamental. It uses the same logic as
